            ...
            <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div className="relative space-y-8 py-12 p-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    APP based learning,top-notch industary mentors 
                  </p>
                </div>
                <a
            ...
            <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div className="relative space-y-8 py-12 p-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    4 mini,4 major projects with mentor guidence
                    rsume building,
                  </p>
                </div>
                <a
            ...
            <div className="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div className="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    45 days of placement trainning,15 mock interviews 
                    100% placement assistance,8 interview opportunities 
                  </p>
                </div>
                <a
                  href="https://forms.gle/cYgDjY7qJCLVER9w5"
