        ...
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <p class="text-gray-600 dark:text-gray-300">
              Lorem ipsum dolor sit amet consecjhJhcvashodhv
            </p>
          </div>
...
describe('Projects', () => {
    ...
    // The function renders an h2 element with the class "my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl".
    it('should render an h2 element with the class "my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl"', () => {
      const wrapper = shallow(<Projects />);
      expect(wrapper.find('h2.my-8.text-2xl.font-bold.text-gray-700.dark:text-white.md:text-4xl')).toHaveLength(1);
    });
});
