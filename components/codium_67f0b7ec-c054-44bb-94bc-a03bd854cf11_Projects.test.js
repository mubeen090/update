...
describe('Projects', () => {
    ...
    // The function renders a div with the class "md:w-2/3 lg:w-1/2".
    it('should render a div with the class "md:w-2/3 lg:w-1/2"', () => {
      const wrapper = shallow(<Projects />);
      expect(wrapper.find('.md:w-2/3 lg:w-1/2')).toHaveLength(1);
    });
});
